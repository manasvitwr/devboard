<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs"
    Inherits="DevBoard.Pages.Pages.Auth.Login" %>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <h2 class="card-title text-center mb-4">
                            <img src='<%=ResolveUrl("~/assets/icons/login.svg")%>' alt="" width="24" height="24"
                                style="vertical-align:-4px;margin-right:6px;"> Login to DevBoard
                        </h2>
                        ...
                        <asp:Login ID="LoginControl" runat="server" OnAuthenticate="LoginControl_Authenticate"
                            ...
                            <LayoutTemplate>
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox ID="UserName" runat="server" CssClass="form-control" TextMode="Email">
                                    </asp:TextBox>
                                ...
                                <div class="mb-3 form-check">
                                    ...
                                    <asp:Label ID="RememberMeLabel" runat="server" AssociatedControlID="RememberMe"
                                        CssClass="form-check-label">Remember me</asp:Label>
                                </div>
